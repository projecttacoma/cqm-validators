module CqmValidators
      ...
      measure_ids = QDM::Measure.all.map(&:hqmf_id)
      ...
      bundle_neutral_ids = QDM::Measure.distinct(:hqmf_set_id)
      ...
      doc_bundle_neutral_ids.each do |hqmf_set_id|
        ...
        if QDM::Measure.where(hqmf_id: measure_id_entry, hqmf_set_id: hqmf_set_id).length() == 0
